...
public class Mode_CreateCompoLine extends Modes {

	private Port Line_Start_Port, Line_End_Port;
	
	public Mode_CreateCompoLine() {
		super(4);
	}
	...
	public void CreatCompoLine() {
		if( this.Line_Start_Port!=null && this.Line_End_Port!=null ) {
			Canvas.getInstance().getArrayList().add( new Line_CompositionLine( Line_Start_Port, Line_End_Port ) );
